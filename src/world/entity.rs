...
/// A passive, wandering mob (chickens, pigs, penguins, cats, cows).
/// All per-species behaviour and tuning lives in `def`; the type aliases below
/// pick a species purely by which `EntityDef` is supplied at construction.
pub struct Entity {
    pub position: [f32; 3],
    pub yaw: f32,
    pub anim_time: f32,
