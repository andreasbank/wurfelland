...
impl OptionsMenuRenderer {
    pub fn new() -> Self {
        ...
        window.add_button(TextButton::new("back", "BACK", (0.35, 0.82, 0.65, 0.91)));
        OptionsMenuRenderer { window }
    }

    pub fn draw(&mut self, fog_idx: usize, chunk_radius_idx: usize, outline_enabled: bool, hi_res: bool, win_w: f32, win_h: f32) {
